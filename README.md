...
A auth with express, passport, and passport-session and base-mongo - a solution for Nodejs applications
...
#### 1. Create a package project
    ...
    ```bash
    git clone https://github.com/JuliusAgency/auth-ses-mongo-set.git .
    ```
    Install:
    ```bash
    npm install
